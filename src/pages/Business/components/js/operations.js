...
const projNameData = proj_name_data => {
  return get("https://raw.githubusercontent.com/Jerry7379/datatest/master/proj_name_data.json");
};
console.log(projNameData);
console.log(projNameData.name);
console.log(projNameData.name.name);
